...
- **Модальные карточки** с изображениями, цветами и управлением количеством
...
- **Защита от случайного закрытия/перезагрузки** с настраиваемым подтверждением
...
- **Визуальная обратная связь** - четкое отображение выбранных элементов
- **Настройки мультивыбора** - отдельная настройка для каталога и коллекции
...
├── Minifig_png/     # Для изображений минифигурок в боковой панели
│   └── minifig-count.txt
